package com.eep.wo.web.rest;

import com.eep.wo.config.Constants;
import com.eep.wo.WorksOrderBookApp;
import com.eep.wo.domain.Authority;
import com.eep.wo.domain.User;
import com.eep.wo.repository.AuthorityRepository;
import com.eep.wo.repository.UserRepository;
import com.eep.wo.security.AuthoritiesConstants;
import com.eep.wo.service.MailService;
import com.eep.wo.service.dto.UserDTO;
import com.eep.wo.web.rest.errors.ExceptionTranslator;
import com.eep.wo.web.rest.vm.KeyAndPasswordVM;
import com.eep.wo.web.rest.vm.ManagedUserVM;
import com.eep.wo.service.UserService;
...
@SpringBootTest(classes = WorksOrderBookApp.class)
